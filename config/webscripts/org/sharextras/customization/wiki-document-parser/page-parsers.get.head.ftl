...
<!-- Wiki Rich Content Document Parser -->

<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/extras/components/wiki/document-parser.css" />
<@script type="text/javascript" src="${page.url.context}/res/extras/components/wiki/document-parser.js"></@script>
